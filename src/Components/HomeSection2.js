...
//         <section
//           key={property.id}
//           className="w-full flex flex-col justify-center items-start px-10 relative z-0"
//         >
//           {/* Property Title */}
//           <div className="mb-6">
...
//             <div className="w-1/2 h-[300px] rounded-lg overflow-hidden relative ml-0 border border-gray-600">
//               <video
...
//             <div className="w-1/2 h-[300px] flex justify-end relative mr-0">
