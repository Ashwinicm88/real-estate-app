          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="border-b border-gray-500">
                <th className="px-2 py-2 text-left">Client Name</th>
                <th className="px-2 py-2 text-left">Email</th>
                <th className="px-2 py-2 text-left">Phone Number</th> {/* Added Phone Number Column */}
                <th className="px-2 py-2 text-left">Date</th>
                <th className="px-2 py-2 text-left">Time</th>
                <th className="px-2 py-2 text-left">Confirm</th>
              </tr>
            ...
            <tbody>
              {bookings.length === 0 ? (
                ...
                bookings.map((booking, index) => (
                  <tr key={index} className={` ${booking.confirmed ? "border-b border-gray-900" : "border-b border-gray-900"}`}>
                    <td className="px-2 py-2">{booking.name}</td>
                    <td className="px-2 py-2">{booking.email}</td>
                    <td className="px-2 py-2">
