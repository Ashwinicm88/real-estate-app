        ...
        <div className="flex-1">
            ...
            <div className="grid grid-cols-2 gap-5 items-center">
              <>
                ...
                <InputField
                  ...
                  section="project"
                  field="projectimages"
                  value={formData.project.projectimgaes}
                  onChange={handleChange}
                  error={warnings.project?.projectimgaes}
                />
                <InputField
                  label="Schools"
                  section="project"
                ...
                <InputField
                  ...
                  section="project"
                  field="movietheater"
                  value={formData.project.movietheaters}
                  onChange={handleChange}
                  error={warnings.project?.movietheaters}
                />
                <ToggleButton
                  label="Deleted"
                  section="projectDetails"
          ...
          {formData.projectDetails.bhk1 && stage === 4 && (
            <>
              ...
              />
              <InputField
                label="1 BHK Type 3 Units"
                section="oneBHKConfig"
                field="type3Units"
                value={formData.oneBHKConfig.type3Units}
                onChange={handleChange}
                error={warnings.oneBHKConfig?.type3Units}
              />
            </>
          )}
...
// //       is: true,
// //       then: yup.string().required("Type 1 Units is required"),
// //     }),
// //     type2Units: yup.string(),
// //     type3Units: yup.string(),
// //   }),
// // });
...
//     const isValid = await validateField(section, field, value);
//     if (!isValid) {
//       // If the field is invalid, set the warning state accordingly
//       setWarnings((prev) => ({
//         ...prev,
//         [section]: {
//           ...prev[section],
//           [field]: warnings[section]?.[field] || "Field is invalid",
//         },
//       }));
//     } else {
//       // Clear the warning for the field if it's valid
//       setWarnings((prev) => ({
//         ...prev,
//         [section]: {
//           ...prev[section],
...
//       await validationSchema.validateAt(`${section}.${field}`, {
//         ...formData[section],
//         [field]: value,
//       });
//       return true;
